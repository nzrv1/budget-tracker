...
const en = {
  ...
  budgets: {
    ...
    sortAria: 'Sort',
    sortNameLabel: 'Category A–Z',
    sortUsageLabel: 'Most used',
    sortLimitLabel: 'Highest limit',
  ...
  settings: {
    ...
    setupWizardSubtitle: 'Answer a few questions and have budgets, dates and goals set up for you.',
    setupWizardButton: 'Run the setup wizard again',
